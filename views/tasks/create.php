<div class="container mt-5">
    ...
    <form action="?controller=main&action=store" method="post">
        <div class="mb-3">
            ...
            <input required type="text" name="user_name" class="form-control" id="exampleFormControlInput1" placeholder="Мухит">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea required name="task_text" class="form-control" id="exampleFormControlTextarea1" rows="1"></textarea>
        </div>
        <div class="mb-3">
